...
export default class MoviesAPIController {
  ...
  public static async getMovieOffer(_req: Request, res: Response): Promise<void> {
    const movieOffer = await MoviesAPIService.getMovieOffer();

    res.status(200).json(movieOffer);
  }
